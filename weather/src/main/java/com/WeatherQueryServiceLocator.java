...
public class WeatherQueryServiceLocator extends org.apache.axis.client.Service implements WeatherQueryService {
    ...
    public WeatherQueryServiceLocator(String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for WeatherQuery
    private String WeatherQuery_address = "http://localhost:8080/services/WeatherQuery";
    ...
    private String WeatherQueryWSDDServiceName = "WeatherQuery";

    public String getWeatherQueryWSDDServiceName() {
        return WeatherQueryWSDDServiceName;
    }

    public void setWeatherQueryWSDDServiceName(String name) {
        WeatherQueryWSDDServiceName = name;
    }

    public WeatherQuery_PortType getWeatherQuery() throws javax.xml.rpc.ServiceException {
    ...
    public WeatherQuery_PortType getWeatherQuery(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public void setWeatherQueryEndpointAddress(String address) {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (WeatherQuery_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
